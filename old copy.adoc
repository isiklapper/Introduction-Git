...
This is the IHO repository for developing the next edition of the S-100 Universal Hydrographic Data Model.
...
S-100 Ed 5.2.0 - Universal Hydrographic Data Model ** Part 0 Overview ** Part 1 Conceptual Schema Language ** Part 2 Management of Registers ** Part 2a Concept and Data Dictionary Registers ** Part 2b Portrayal Register Model ** Part 3 General Feature Model and Rules for Application Schema
These documents are encoded in the https://www.metanorma.org/author/topics/document-format/[Metanorma AsciiDoc format].

== Structure

sources/:: source of the S-100 documents and models
